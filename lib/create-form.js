...
export const createForm = (config) => {
  ...
  function validateFieldValue(field, value, allValues) {
  ...
  function updateValidateField(field, value, allValues) {
    updateField(field, value, allValues);
  ...
  function handleChange(event) {
    ...
    return util.subscribeOnce(form).then((values) => {
      return updateValidateField(field, value, values);
    });
